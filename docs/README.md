...
| [main1-scroll-interactions.md](./main1-scroll-interactions.md) | **main-1 스크롤 인터랙션 시스템** ✅ (2026-06-25) — 3페이지 인플로우 자연 스크롤·다크↔라이트 색반전(`--inv` 3/5)·명칭 모프+핸드오프·11개 다국어+단어 rise·**휠 섹션 캡(1P→2P, 데스크탑)/모바일 CSS 스냅**·**디자인 이력서 2단**·라이트 글라스·**리빌(is-settled/IO)**·맨위로 버튼·반응형 |
