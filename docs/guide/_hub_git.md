...
| C-7 | **실제 연동 현황** | 계정·레포·인증·브랜치·`.env` 실값·검증 명령 | [git-connection](../git-connection.md) ⭐ |
...
- 정본(규약): [`git-setup.md`](../git-setup.md) — 원칙·절차·보안
- 정본(현황): [`git-connection.md`](../git-connection.md) ⭐ — 실제 연결된 계정·레포·인증·브랜치·`.env` 실값
